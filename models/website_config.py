...
class website(models.Model):
    ...
    def get_website_config(self):
        config_ids = self.env["ir.config_parameter"].sudo().get_param('website_test.stock_type')
...
class website_config(models.TransientModel):
    ...
    def get_values(self):
        ...
        res.update(stock_type = self.env['ir.config_parameter'].sudo().get_param('website_test.stock_type', default='available'))
        return res
    def set_values(self):
        super(website_config, self).set_values()
        self.env['ir.config_parameter'].sudo().set_param('website_test.stock_type', self.stock_type)
